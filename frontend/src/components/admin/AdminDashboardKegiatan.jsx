...
const AdminDashboardKegiatan = () => {
  ...
  // === Refactor flow delete ===
  const handleDelete = async (id) => {
    // ganti confirm → toast confirm bisa dipakai, tapi kita biarkan confirm untuk UX minimal
    const confirmDelete = confirm(
      "⚠️ Apakah Anda yakin ingin menghapus kegiatan ini?"
    );
    ...
    return (
      <div className="flex justify-center items-center min-h-96">
        <div className="text-center max-w-md">
          ...
          <Button
            onClick={() => refetch()}
            className="!rounded-xl px-6 py-3 bg-gradient-to-r from-red-500 to-red-600 hover:from-red-600 hover:to-red-700"
          >
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-gray-500 mt-1 font-medium">
                Kelola kegiatan desa dan program bantuan dengan mudah
              </p>
            </div>
          </div>
        </div>
            ...
            <CardContent className="p-6 relative z-10">
              <div className="flex items-center justify-between mb-4">
                <div>
                  ...
                  <p
                    className={`text-2xl font-bold mt-2 ${stat.textColor} group-hover:scale-110 transition-transform duration-300`}
                  >
                ...
                >
                  ...
                  <div className="relative h-56 overflow-hidden">
                    <img
                      src={
                        item.foto_url ||
                        `https://readdy.ai/api/search-image?query=Indonesian%20village%20activity%20${item.kategori}&width=400&height=300&seq=${item.id}`
                      }
                      alt={item.judul}
        ...
        >
          ...
          <div className="space-y-6 pt-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-4">
                <div>
                  <Label htmlFor="judul" className="text-base font-semibold">
                    📝 Judul Kegiatan *
                  </Label>
                  <Input
                    id="judul"
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setFormData({ ...formData, target_dana: e.target.value })
                    }
                ...
                <div>
                  <Label htmlFor="lokasi" className="text-base font-semibold">
                    📍 Lokasi
                  </Label>
                  <Input
                    id="lokasi"
              ...
              <div className="space-y-4">
                ...
                <div>
                  <Label htmlFor="foto_url" className="text-base font-semibold">
                    🖼️ URL Foto
                  </Label>
                  <Input
                    id="foto_url"
