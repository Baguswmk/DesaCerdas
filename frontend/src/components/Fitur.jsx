  ...
  const features = [
    {
      ...
      title: "BantuDesa",
      description:
        "Platform donasi transparan untuk membantu pembangunan infrastruktur dan pemberdayaan masyarakat desa",
      icon: "🤝",
    ...
    },
    {
      ...
      title: "TanyaHukum",
      description:
        "Konsultasi hukum gratis dengan AI yang dilengkapi referensi undang-undang terkini dan panduan lengkap",
      icon: "⚖️",
    ...
    },
    {
      ...
      title: "FarmSmart",
      description:
        "Rekomendasi pertanian cerdas dengan data cuaca BMKG, analisis tanah, dan panduan lengkap budidaya",
      icon: "🌱",
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0">
        <div className="absolute top-1/4 left-1/4 w-64 h-64 sm:w-96 sm:h-96 bg-emerald-200/20 rounded-full blur-3xl animate-pulse"></div>
        <div className="absolute bottom-1/4 right-1/4 w-48 h-48 sm:w-80 sm:h-80 bg-emerald-300/15 rounded-full blur-3xl animate-pulse delay-1000"></div>
        <div className="absolute top-3/4 left-1/2 w-40 h-40 sm:w-64 sm:h-64 bg-emerald-100/20 rounded-full blur-3xl animate-pulse delay-2000"></div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="text-center mb-12 sm:mb-16 lg:mb-20">
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 mb-6 sm:mb-8">
            <div className="p-2 sm:p-3 bg-gradient-to-r from-emerald-500 to-green-500 rounded-2xl shadow-xl">
              <Sparkles className="h-6 w-6 sm:h-8 sm:w-8 text-white" />
            </div>
            <div>
              <h2
                className={`text-3xl py-3 sm:text-4xl md:text-5xl lg:text-6xl font-black bg-gradient-to-r from-emerald-600 to-green-600 bg-clip-text text-transparent `}
              >
                Platform Digital
              </h2>
             
              <div className="h-0.5 sm:h-1 w-24 sm:w-32 bg-gradient-to-r from-emerald-500 to-green-500 rounded-full mx-auto mt-3"></div>
            </div>
          </div>
          ...
          {features.map((feature, index) => (
            ...
            >
              ...
              >
                ...
                <div
                  className={`absolute inset-0 bg-gradient-to-br ${feature.bgGradient} opacity-0 group-hover:opacity-5 transition-opacity duration-500`}
                ></div>

                {/* Content */}
                <CardHeader className="text-center pt-6 sm:pt-8 lg:pt-10 pb-4 sm:pb-6 relative z-10">
                  {/* Enhanced Icon */}
                  <div className="relative mb-4 sm:mb-6">
                    <div
                      className={`w-16 h-16 sm:w-20 sm:h-20 mx-auto rounded-2xl flex items-center justify-center shadow-xl transform group-hover:scale-110 group-hover:rotate-3 transition-all duration-500 ${
                        isDarkMode
                    ...
                    {/* Emerald Glow effect */}
                    <div
                      className={`absolute inset-0 bg-gradient-to-br ${feature.bgGradient} opacity-0 group-hover:opacity-20 blur-xl transition-opacity duration-500 rounded-2xl`}
                    ></div>
                  </div>
                  ...
                  <CardTitle
                    ...
                    } group-hover:bg-gradient-to-r group-hover:${
                      feature.bgGradient
                ...
                <CardContent className="px-4 sm:px-6 lg:px-8 pb-6 sm:pb-8 lg:pb-10 relative z-10">
                  <p
                    className={`text-center leading-relaxed mb-6 sm:mb-8 text-sm sm:text-base ${
                  ...
                  <div className="mb-6 sm:mb-8">
                    <div className="space-y-2 sm:space-y-3">
                      {feature.features.map((item, idx) => (
                        ...
                        >
                          <div
                            className={`w-1.5 h-1.5 sm:w-2 sm:h-2 rounded-full bg-gradient-to-r ${feature.bgGradient}`}
                          ></div>
                          <span
                            className={
                              isDarkMode ? "text-gray-300" : "text-gray-700"
                  ...
                  <Button
                    onClick={() =>
                      !feature.disabled && handlePageChange(feature.route)
                    }
                    disabled={feature.disabled}
                    className={`
    w-full py-3 sm:py-4 text-sm sm:text-base font-bold rounded-2xl
    ${
      feature.disabled
        ? "bg-gray-400 cursor-not-allowed opacity-70"
        : `bg-gradient-to-r ${feature.bgGradient} hover:${feature.hoverGradient} text-white`
    }
  ...
  `}
                  >
                    ...
                    <span className="relative z-10 flex items-center justify-center gap-2">
                      <span>
                        {feature.disabled ? "Segera Hadir" : "Mulai Sekarang"}
                      </span>
                      {!feature.disabled && (
                        <ArrowRight className="h-3 w-3 mt-0.5 sm:h-4 sm:w-4 transform group-hover/btn:translate-x-1 transition-transform duration-300" />
                      )}
                    </span>
                  </Button>
                </CardContent>
                ...
                <div className="absolute top-4 sm:top-6 right-4 sm:right-6 opacity-0 group-hover:opacity-100 transition-all duration-300 transform translate-x-2 group-hover:translate-x-0">
                  ...
                  >
                    <ExternalLink className="h-3 w-3 sm:h-4 sm:w-4 text-emerald-500" />
                  </div>
                </div>
              </Card>
            </div>
        ...
        {/* <div className="text-center">
          <div
            className={`inline-flex flex-col items-center gap-4 sm:gap-6 px-8 sm:px-12 py-6 sm:py-8 rounded-3xl ${
              isDarkMode
                ? "bg-gray-800/50 border border-gray-700/50"
                : "bg-white/50 border border-gray-200/50"
