      ...
      <div className="max-w-7xl mb-16 mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-20">
          <div className="flex items-center justify-center gap-3 mb-8">
            ...
            <div>
              <h1 className={`text-5xl md:text-6xl py-4 font-black bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent mb-2`}>
                Tentang Kami
              </h1>
             
              <div className="h-1 w-24 bg-gradient-to-r from-blue-500 to-purple-500 rounded-full mx-auto mt-3"></div>
            </div>
          </div>
          ...
          {achievements.map((achievement, index) => (
            ...
            >
              ...
              <CardContent className="p-6 relative z-10">
                <div className="text-3xl mb-3 transform group-hover:scale-110 group-hover:rotate-3 transition-all duration-300">
                  {achievement.icon}
                </div>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center mb-20">
          ...
          <div className="relative group">
            ...
            {/* Decorative elements */}
            <div className="absolute -top-4 -left-4 w-20 h-20 bg-gradient-to-r from-blue-500 to-purple-500 rounded-2xl opacity-20 transform rotate-12 group-hover:rotate-45 transition-transform duration-500"></div>
        ...
        {/* <div className="text-center">
          <div className={`inline-flex flex-col items-center gap-6 px-12 py-10 rounded-3xl ${
            ...
            <div className="flex flex-wrap justify-center gap-3 mt-4">
              ...
              <div className={`flex items-center gap-2 px-4 py-2 rounded-full ${
                isDarkMode ? 'bg-blue-900/20 text-blue-300 border border-blue-800/30' : 'bg-blue-50 text-blue-700 border border-blue-200'
              } backdrop-blur-sm`}>
                <Shield className="h-4 w-4" />
                <span className="text-sm font-bold">Aman</span>
              </div>
              <div className={`flex items-center gap-2 px-4 py-2 rounded-full ${
                isDarkMode ? 'bg-purple-900/20 text-purple-300 border border-purple-800/30' : 'bg-purple-50 text-purple-700 border border-purple-200'
              } backdrop-blur-sm`}>
