...
const Kontak = () => {  
  ...
  const supportChannels = [
    { icon: MessageCircle, name: "Live Chat", status: "Online", color: "text-green-500" },
    { icon: Mail, name: "Email Support", status: "24/7", color: "text-blue-500" },
    { icon: Phone, name: "Phone Support", status: "Jam Kerja", color: "text-orange-500" },
    { icon: Headphones, name: "Video Call", status: "Tersedia", color: "text-purple-500" }
  ];
          ...
          <Card className={`border-0 shadow-xl hover:shadow-2xl transition-all duration-500 ${
            ...
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <Button 
                  type="submit"
                  className="w-full !rounded-2xl py-4 text-base font-black bg-gradient-to-r from-blue-500 to-purple-500 hover:from-blue-600 hover:to-purple-600 text-white shadow-xl hover:shadow-2xl transform hover:scale-105 transition-all duration-300 relative overflow-hidden group"
                >
                  {/* Shine effect */}
